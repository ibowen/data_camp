...
public class TweetSpout extends BaseRichSpout
{
  ...
  LinkedBlockingQueue<List<String>> queue = null;
  ...
  private class TweetListener implements StatusListener {
    ...
    public void onStatus(Status status)
    {
      ...
      alist.add(Long.toString(status.getId()));
      alist.add(Integer.toString(status.getRetweetCount()));
      alist.add(status.getText());
      DateFormat dateFormat = new SimpleDateFormat("yyyy-mm-dd hh:mm:ss");
      alist.add(dateFormat.format(status.getCreatedAt()));
      queue.offer(alist);
    }
      ...
      SpoutOutputCollector    spoutOutputCollector)
  {
    ...
    queue = new LinkedBlockingQueue<List<String>>(1000);
  ...
  public void nextTuple()
  {
    ...
    collector.emit(new Values(ret.get(0), ret.get(1), ret.get(2), ret.get(3)));
  }
      ...
      OutputFieldsDeclarer outputFieldsDeclarer)
  {
    ...
    outputFieldsDeclarer.declare(new Fields("id", "retweetCount", "text", "createdAt"));
  }
}
